...
class _HealthConcernScreenState extends State<HealthConcernScreen> {
  final List<Map<String, dynamic>> healthConcerns = [
    {
      'title': '면역력 강화',
      'icon': 'assets/icons/eye_health.png',
    ...
    {
      'title': '피로 회복',
      'icon': 'assets/icons/gut_health.png',
    ...
    {
      'title': '피부 건강',
      'icon': 'assets/icons/skin_health.png',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('4/10', style: TextStyle(color: Colors.grey)),
        centerTitle: true,
