    ...
    return ChangeNotifierProvider(
      ...
      child: Consumer<GetInfoViewModel>(
        builder: (context, viewModel, child) {
          return _GetInfoScreen(viewModel: viewModel);
        },
      ),
    );
  }
...
class _GetInfoScreen extends StatelessWidget {
  const _GetInfoScreen({required this.viewModel});
  final GetInfoViewModel viewModel;
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Expanded(child: _buildGenderButton(context, '남성', 'male')),
